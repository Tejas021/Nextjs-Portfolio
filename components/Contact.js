...
const Contact = () => {
        ...
        <div className={styles.cWrapper}>
            ...
            <div className={styles.cLeft}>
                ...
                <div className={`${styles.cInfo}  text-black sm:text-white dark:text-white sm:dark:text-black`}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-black-600" viewBox="0 0 20 20" fill="currentColor">
  ...
  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  ...
                  </div>tejaskolwankar021@gmail.com</div>
                    <div className={styles.cInfoItem}>
                    <div className={styles.cIcon}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-black-600" viewBox="0 0 20 20" fill="currentColor">
  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                    ...
                    <p> C 305 , Jayraj Nagar , 100ft road , Near Manav Mandir , Vasai West</p>
                  </div>
                </div>
                </div>
